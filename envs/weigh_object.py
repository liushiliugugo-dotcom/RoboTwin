...
class weigh_object(Base_Task):
    ...
    def load_actors(self):
        ...
        # Object to weigh: pick from phone, pill bottle, remote control
        object_list = ["077_phone", "080_pillbottle", "079_remotecontrol"]
        ...
        if not available_model_ids:
            raise ValueError(f"No model_data files found for {self.selected_modelname}")
    ...
    def check_success(self):
        ...
        return (distance < 0.035 and object_pose[2] > (scale_pose[2] - 0.01) and check_arm())
